  ...
  return (
    <div className="flex-1 max-w-7xl mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <Card glass className="bg-gradient-to-br from-yellow-50 to-pastel-yellow-100 border-none w-full">
        ...
        {(!user?.vipExpiresAt || user.vipExpiresAt < new Date()) && (
          <Card className="border-2 border-yellow-400 bg-yellow-50 w-full flex flex-col justify-center">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Kích hoạt tài khoản VIP</h3>
            <p className="text-sm text-gray-600 mb-4">Nhập mã kích hoạt 1 năm để mở khóa toàn bộ khóa học và tính năng đặc quyền.</p>
            <div className="flex gap-2">
              <input 
                type="text" 
                placeholder="Ví dụ: ABCD-1234" 
                className="flex-1 px-4 py-2 border border-yellow-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 bg-white uppercase"
              />
